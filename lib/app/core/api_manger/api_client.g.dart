...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<HttpResponse<SignupDto>> signUp(Map<String, dynamic> body) async {
  ...
  Future<HttpResponse<ForgotPasswordResponse>> forgotPassword(
    ...
    final _options = _setStreamType<HttpResponse<ForgotPasswordResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'auth/forgotPassword',
  ...
  Future<HttpResponse<VerifyResetCodeResponse>> verifyResetCode(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<HttpResponse<VerifyResetCodeResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<HttpResponse<AllCategoriesDto>> getAllCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<AllCategoriesDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/categories',
  ...
  @override
  Future<HttpResponse<HomeResponse>> getHomeData() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<HomeResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/home',
  ...
  Future<HttpResponse<ProductDetailsResponse>> getProductDetails(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ProductDetailsResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products/${productId}',
  ...
  @override
  Future<HttpResponse<UserCartsDto>> getUserCarts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<UserCartsDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'cart',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserCartsDto _value;
    try {
      _value = UserCartsDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      // errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<UserCartsDto>> deleteCartItem(String cartItemId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<ProfileResponse>> getProfileData(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
