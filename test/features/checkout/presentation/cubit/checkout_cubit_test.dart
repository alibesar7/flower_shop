...
ApiResult<List<AddressModel>> dummyAddressResult = SuccessApiResult<List<AddressModel>>(
  data: [],
);

ApiResult<CashOrderModel> dummyCashOrderResult = SuccessApiResult<CashOrderModel>(
  data: CashOrderModel(
    id: 'dummy',
    userId: 'dummy',
    items: [],
