...
import 'package:flower_shop/features/e_commerce/pages/occasion/manager/occasion_cubit.dart';
import 'package:flower_shop/features/e_commerce/pages/occasion/manager/occasion_event.dart';
...
void main() {
  ...
  group("occasion cubit test", () {
    group("_getProduct", () {
      ...
      test(" emits success when usecase returns success", () async {
        List<ProductModel> products = [
          ProductModel(id: "id", name: "name", imageUrl: "imageUrl", price: 20),
        ];
    ...
    group("_onTabChanged", () {
      const tTab = 'new_tab';
      final tProducts = [
        ProductModel(id: '1', name: 'Test Product', imageUrl: 'image.png', price: 10.0),
      ];
