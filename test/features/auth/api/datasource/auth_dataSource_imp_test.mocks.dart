...
// in flower_shop/test/features/auth/api/datasource/auth_dataSource_imp_test.dart.
...
class MockApiClient extends _i1.Mock implements _i3.ApiClient {
  ...
  @override
  _i4.Future<_i2.HttpResponse<_i5.LoginResponse>> login(
    _i6.LoginRequest? loginRequest,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#login, [loginRequest]),
            returnValue: _i4.Future<_i2.HttpResponse<_i5.LoginResponse>>.value(
              _FakeHttpResponse_0<_i5.LoginResponse>(
                this,
                Invocation.method(#login, [loginRequest]),
              ),
            ),
          )
          as _i4.Future<_i2.HttpResponse<_i5.LoginResponse>>);
}
